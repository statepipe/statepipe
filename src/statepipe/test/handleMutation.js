...
test('unexpected context', t => {
    ...
    t.is(null, handleMutation({})) 
    t.is(null, handleMutation(function(){})) 
})
...
test(`attributeName: ${utils.ACTION_ATTR}`, t => {
    ...
    ctx.wrapper.setAttribute(utils.PAYLOAD_ATTR,JSON.stringify({value:"payload"}))
...
test(`attributeName: ${utils.STATE_ATTR}`, t => {
    const n1 = contexts.element(utils.OUT_ATTR, "text:value:foo|pass:foo,mult:b|mult:c")
